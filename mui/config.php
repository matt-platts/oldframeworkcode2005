...
$libpath_abs="/var/www/vhosts/paragon-digital.net/shop/system/lib/lib_v3"; // OR you can specify an absolute directory
$iopath_local="/system/io";
$sysimgpath_local="/system/graphics";
$systempath_local="system";
$http_path="http://shop.paragon-digital.net/admin";
$http_root="http://shop.paragon-digital.net";
$install_root="/var/www/vhosts/paragon-digital.net/shop";
$desktop_dir="desktop";
...
if (preg_match("/admin/",$basepath)){$basepath .= "/.."; } 
