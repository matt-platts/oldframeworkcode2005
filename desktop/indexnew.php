...
<head>
	...
	<title>London Steakhouse Company - Virtual Desktop</title>
	...
	<link rel="stylesheet" type="text/css" href="../css/system_classes.css" />
	<!-- overwrite the row mouseovers for the panels //-->
	<style type="text/css">
		.tr_1_col {
	...
	<script type="text/javascript" src="scripts/desktop_with_cols.js.php"></script>
...
//-->
	...
	<div id="pageWrapper" class="mainPageContent" width="100%" >
		<div id="page" style="position:absolute; left:7px;" >
			<style type="text/css">
	...
	<div id="desktopFooterWrapper">
		<div id="desktopFooter">
			&copy; 2011 Matt Platts <a target="_blank" href="http://www.paragon-digital.com/">Paragon Digital</a> 
		</div>
	</div>
