...
static function build_select_option_list($comma_separated_list,$selected,$default_if_no_selected,$blank_entry_at_top,$blank_entry_selected,$list_delimiter,$blank_entry_text){
...
*/
static function get_sql_list_values($query,$id_value,$list_delimiter=","){
	global $db;
	if (!$list_delimiter){$list_delimiter=",";}
...
*/
static function check_dbf_permissions($table, $permission_type, $permission_rowid, $options=null){
	global $db;
	global $user;
...
static function csv_to_options($csl,$selected,$classes){
        $select_options=array();
...
static function date_input_field($selected_date,$rowid_for_edit,$fieldname,$options){
