...
class dynamic_form extends baseController {
	...
	function __construct($tablename,$formtype,$rowid_for_edit,$add_data,$options,$form_name){
	...
	*/
	...
	public function draw_select_input_field($fieldname,$allow_multiple_select){
...
,word_wrap: true
		...
		if ($this->options['filter']['submit_button_text']){
			...
			if ($this->formtype == "edit_single" || $this->formtype == "edit_all"){
				if ($submit_element_type=="button"){
					...
					$this->submit_button = "<input type=\"image\" src=\"$img_src\" alt=\"Save Record\" title=\"Save Record\" > ";
				}
	...
	public function draw_save_and_continue_button(){
			$this->save_and_continue_button = "<input type=\"hidden\" name=\"after_update_page_element\" value=\"\"><input type=\"image\" src=\"".SYSIMGPATH."/application_images/save_edit_beige_43x39.png\" onClick=\"document.forms['update_table'].elements['after_update_page_element'].value='continue';\" alt=\"Save and continue editing record\" title=\"Save and continue editing record\">\n ";
