...
function display(){
	...
	if (!$user->value("id")) {
		?>  
		<div id="admin_login_div"><p style="text-align:left; float:left;"><? if ($_GET['error']){
		print "<span style=\"color:#990000\">Login details not recognised</span>";}?></p><p style="clear:both">
		<h4 width="400" style="width:400px; text-align:left;">Please log in:</h4>
		<form action="/login/process_login" method="post" name="login_form" onsubmit="check_login()">
