...
$sql="SELECT orders.id as orderno, user.first_name,user.second_name,orders.datetime FROM orders INNER JOIN user ON orders.ordered_by = user.id WHERE orders.complete IS NOT NULL ORDER BY datetime DESC";
